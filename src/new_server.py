...
from src.summanote_pipeline import SummanotePipeline
...
pipeline = SummanotePipeline(root_path="./data")
...
async def transcribe(request: Request, status_code=status.HTTP_200_OK):
    ...
    try:
        ...
        file_path = os.path.join(pipeline.current_note_name, file_name)
